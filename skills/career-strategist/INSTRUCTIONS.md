...
### Step 1: Target Acquisition (Intake)
...
### Step 4: Trigger Optional Deep-Dives (Guided Steps)
...
### Step 6: Dossier Generation (Cumulative Synthesis)
...
## Tool Reference (ARI)
- **pdf_parser.py**: `./tools/ari tools/pdf_parser.py [PDF_PATH]` - Used to extract technical DNA from Job Description (JD) PDFs.
