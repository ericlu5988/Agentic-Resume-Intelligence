...
## Tool Reference (ARI)
- **importer_engine.py**: `./tools/ari tools/importer_engine.py [TAILORED_JSON] templates/master_resume_template.tex [OUTPUT_TEX]`
- **compile_resume.py**: `./tools/ari tools/compile_resume.py [OUTPUT_TEX]`
- **pdf_parser.py**: `./tools/ari tools/pdf_parser.py [OUTPUT_PDF]` - Used to verify page counts and line density.
